...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', # Put CORS here
...
CORS_ALLOW_ALL_ORIGINS = True # Development config

ROOT_URLCONF = 'TennisIQ.urls'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(MEDIA_ROOT, 'logs', 'processing.log'),
        },
    },
    'loggers': {
        'django': {
